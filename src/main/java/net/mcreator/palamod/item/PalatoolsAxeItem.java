...
public class PalatoolsAxeItem extends PalaModModElements.ModElement {
	@ObjectHolder("pala_mod:palatools_axe")
	public static final Item block = null;

	public PalatoolsAxeItem(PalaModModElements instance) {
		super(instance, 8);
	}
